...
module.exports = function (app) {
    ...
    app.post('/api/friends', function (req, res) {
        ...
        friends.forEach(function (friend) {
            ...
            // This loops through each item of the scores arrays from both the stored data and the new user, and then substracts, absolutes, and then pushes the new value to the matchedScoresArray
        ...
        // Once the cycle is complete, the match with the least difference will remain, and that data will be sent as a json object back to the client
        res.json({
            name: matchName,
            photo: matchPhoto
        });
